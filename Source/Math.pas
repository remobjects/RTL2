...
type
  ...
  public
    ...
    property MaxInt32: Integer read {$IF COOPER}Int32.MAX_VALUE{$ELSEIF ECHOES}Int32.MaxValue{$ELSEIF TOFFEE}rtl.INT32_MAX{$ENDIF};
    property MinInt32: Integer read {$IF COOPER}Int32.MIN_VALUE{$ELSEIF ECHOES}Int32.MinValue{$ELSEIF TOFFEE}rtl.INT32_MIN{$ENDIF};
